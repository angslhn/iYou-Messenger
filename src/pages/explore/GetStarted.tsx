...
export default function GetStarted(): JSX.Element {
    ...
    return (
        <main className="h-[100dvh] min-h-180 flex justify-center bg-night overflow-y-scroll [scrollbar-width:none]">
            <div className="flex flex-col justify-between min-h-full w-full gap-6 xs:max-w-90 s:max-w-97.5 s-medium:max-w-112.5 px-4 py-10">
                <div className="flex flex-col gap-1">
                    <h1 className="font-extrabold text-5xl text-platinum tracking-tight leading-none">
                        iYou
                    </h1>
                    <span className="text-platinum/40 font-bold tracking-widest uppercase">
                        Messenger
                    </span>
                </div>
                    ...
                    {[
                        ...
                        <div key={f.title} className="flex items-center gap-4">
                            ...
                            <div className="flex flex-col gap-0.5">
                                ...
                                <span className="text-[0.85rem] leading-snug text-platinum/50">
                                    {f.desc}
                                </span>
                            </div>
                        </div>
