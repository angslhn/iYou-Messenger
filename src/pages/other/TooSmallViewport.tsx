...
export default function TooSmallViewport(): JSX.Element {
  return (
    <main className="flex xxs:hidden h-screen w-full flex-col items-center justify-center text-center px-4 bg-night">
      <div className="w-full flex flex-col items-center p-6 bg-dark-charcoal rounded-3xl border border-ebony-light shadow-2xl">
        ...
        <h2 className="text-xl font-bold text-platinum/85 mb-2">Screen Too Small</h2>
        <p className="text-xs text-platinum/50 leading-relaxed">
          iYou Messenger requires a minimum screen width of 320px. Please use a larger device for
          the best experience.
        </p>
      </div>
    </main>
